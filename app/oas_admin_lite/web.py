...
def script_fields(action, values=None):
    ...
    if action["mode"] == "catalog_report":
        ...
        <section class="report-field-section report-required full"><h3>\ud544\uc218 \ud56d\ubaa9</h3><div class="report-field-grid">
          <label class="full">Report output file<input name="report_output" value="{output}" placeholder="/u01/oas-admin-lite/backups/catalog-audit.csv"></label><label>Object type<select name="report_type">{types}</select></label><label>Report fields<input name="report_fields" value="{fields}" placeholder="Name:Path:Owner:Modified:ACL"></label><label>OBIPS URL<input name="report_online" value="{online}" placeholder="https://oas.example.com/analytics/saw.dll"></label><label class="full">Credentials properties file<input name="report_credentials" value="{credentials}" placeholder="/u01/oas-admin-lite/data/catmancredentials.properties"></label>
        </div></section>
        <section class="report-field-section report-optional full"><h3>\uc635\uc158 \ud56d\ubaa9</h3><div class="report-field-grid">
          <label>Catalog folder<input name="report_folder" value="{folder}" placeholder="/shared"></label><label>Recursion depth<input name="report_depth" value="{depth}" inputmode="numeric"></label><label>Skip types<input name="report_skip_types" value="{skip_types}" placeholder="Action:Favorites List"></label><label>Skip folders<input name="report_skip_folders" value="{skip_folders}"></label><label class="full">Delimiter<input name="report_delimiter" value="{delimiter}" placeholder="Default: tab"></label>
